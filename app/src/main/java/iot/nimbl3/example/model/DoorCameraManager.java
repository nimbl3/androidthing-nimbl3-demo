package iot.nimbl3.example.model;
...
public class DoorCameraManager {
    private static final String TAG = DoorCameraManager.class.getSimpleName();
    ...
    private DoorCameraManager() {
    }

    private static class InstanceHolder {
        private static DoorCameraManager mCamera = new DoorCameraManager();
    }

    public static DoorCameraManager getInstance() {
